...
urlpatterns = [
    ...
    path(
        "agregar_carrito/<int:ticket_id>", views.agregar_carrito, name="agregar_carrito"
    ),
    ...
    path(
        "editar_productora/<int:id>", views.editar_productora, name="editar_productora"
    ),
    ...
    path(
        "eliminar_ubicacion/<int:id>",
        views.eliminar_ubicacion,
        name="eliminar_ubicacion",
    ),
    path("crear_evento", views.crear_evento, name="crear_evento"),
    path(
        "editar_tickets_evento/<int:evento_id>",
        views.editar_tickets_evento,
        name="editar_tickets_evento",
    ),
]
